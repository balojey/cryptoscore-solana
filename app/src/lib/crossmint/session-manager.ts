...
export class SessionManager {
   ...
   * The Crossmint SDK handles token refresh automatically, but this
   * provides additional validation and monitoring
   */
  ...
  /**
   * Monitor session health and trigger refresh if needed
